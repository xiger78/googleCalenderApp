...
- タイトル右の **再設定** ボタンで当月の出勤日・在宅日の時刻を **00:00** にリセット
...
- **土日・祝日** の日付カードは **灰色背景** で表示（出勤・在宅の色分けとは別）
...
| アプリレイアウト | 上部 **かわいいバナー** + バナー上 **リンクボタンメニュー** に UI 変更 |
| メニュー名 | **日付指定 · 出退時間 · Google登録 · 履歴確認 · 設定** に短縮 |
| 休日表示 | 出退勤時刻画面で土日・祝日カードを **灰色背景** で表示 |
| 再設定 | 出退勤時刻画面タイトル横の **再設定** で時刻を **00:00** に初期化 |
